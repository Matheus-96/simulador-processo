...
const InformacoesProcessuais = ({ handleChangeObject }) => {
    ...
    return (<>
        ...
        <div className="row justify-content-start mt-2">
            ...
            <div className="col-md-9 my-auto d-flex">
                <input className='flex-grow-1 form-control'  onChange={objectChanged} readOnly type="text" name="assuntoProcessual" id="" />
            ...
            <div className="modal-dialog" style={{ maxWidth: '90%' }}>
                <div className="modal-content">
                    ...
                    <div className="modal-footer">
                        ...
                        <button type="button" id="salvarClasse" data-bs-dismiss="modal" className="btn btn-primary">Selecionar</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div className="modal fade" id="modalAssuntoPrincipal" tabndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div className="modal-dialog" style={{ maxWidth: '90%' }}>
                <div className="modal-content">
                    ...
                    <div className="modal-footer">
                        <button type="button" className="btn btn-secondary" data-bs-dismiss="modal">Sair</button>
                        <button type="button" id="salvarAssunto" data-bs-dismiss="modal" className="btn btn-primary">Selecionar</button>
                    </div>
                </div>
            </div>
        </div>
